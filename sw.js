...
// transits.js?v=2, natal-chart.js?v=26.
...
// v104 -> v105 (Ago 7): la estrella del pie no estaba alineada con "Luz
...
const CACHE_NAME = 'luzestelar-v109';
...
const PRECACHE_URLS = [
  ...
  '/data/stars.json',
  '/data/stars-full.json',
  '/data/constellations_zodiac.json',
  '/data/stars_zodiac.json',
