...
(function(){
  ...
  style.textContent = [
    ...
    '}',
    // 20px icon box so SVG lines sit cleanly above the label.
    // When the icon is an SVG, it fills the box with currentColor;
    // when it is an emoji fallback, the font-size takes over.
    '.le-tab-icon{display:flex;align-items:center;justify-content:center;width:22px;height:22px;font-size:18px;line-height:1;}',
