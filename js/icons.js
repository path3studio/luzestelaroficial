...
(function () {
  ...
  var ICONS = {
    ...
    virgo:
      '<path d="M5 17.5V11a2.5 2.5 0 0 1 5 0v6.5"/>' +
      '<path d="M10 11a2.5 2.5 0 0 1 5 0"/>' +
      '<path d="M15 11v8.2"/>' +
      '<path d="M15 15.4c2.9-1.3 5.4.4 5.2 2.9-.2 2.2-2.5 3.4-4.6 2.4-1.7-.8-2.8-2.5-3.4-4.4"/>',
    libra:
    ...
    escorpio:
      ...
      '<path d="M10 11a2.5 2.5 0 0 1 5 0"/>' +
      '<path d="M15 11v7"/>' +
      '<line x1="15" y1="18" x2="20.3" y2="12.7"/>' +
      '<polyline points="16.9 12.7 20.3 12.7 20.3 16.1"/>',
    sagitario:
