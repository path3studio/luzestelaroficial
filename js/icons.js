...
(function () {
  ...
  var ICONS = {
    ...
    // ── Astros (glifos clásicos redibujados, 2026-08-05) ──
    mercurio:
      '<circle cx="12" cy="11" r="3.6"/>' +
      '<path d="M8.4 3.2a3.6 3.6 0 0 0 7.2 0"/>' +
      '<line x1="12" y1="14.6" x2="12" y2="20.8"/>' +
      '<line x1="9.2" y1="17.7" x2="14.8" y2="17.7"/>',
    venus:
      '<circle cx="12" cy="8.6" r="4.6"/>' +
      '<line x1="12" y1="13.2" x2="12" y2="21"/>' +
      '<line x1="8.6" y1="17.1" x2="15.4" y2="17.1"/>',
    marte:
      '<circle cx="9.8" cy="14.2" r="5.2"/>' +
      '<line x1="13.5" y1="10.5" x2="19.8" y2="4.2"/>' +
      '<polyline points="14.6 4.2 19.8 4.2 19.8 9.4"/>',
    jupiter:
      '<path d="M4.6 7.4a3.9 3.9 0 0 1 7.8 0c0 2.7-2.5 4.2-6.6 7.9h12.4"/>' +
      '<line x1="14.6" y1="11" x2="14.6" y2="20.4"/>',
    saturno:
      '<line x1="7.2" y1="3.4" x2="7.2" y2="12.2"/>' +
      '<line x1="4.2" y1="6.4" x2="10.2" y2="6.4"/>' +
      '<path d="M7.2 12.2c1.6-2.2 5.8-2.6 6.8.6.8 2.6-1.6 4.7-3.1 6.7 1 1.4 2.4 1.5 3.5.6"/>',
    urano:
      '<circle cx="12" cy="17.6" r="2.9"/>' +
      '<line x1="12" y1="14.7" x2="12" y2="7.6"/>' +
      '<line x1="7.4" y1="3.6" x2="7.4" y2="11.6"/>' +
      '<line x1="16.6" y1="3.6" x2="16.6" y2="11.6"/>' +
      '<line x1="7.4" y1="7.6" x2="16.6" y2="7.6"/>',
    neptuno:
      '<path d="M5 3.6v2.8a7 7 0 0 0 14 0V3.6"/>' +
      '<line x1="12" y1="3.6" x2="12" y2="20.6"/>' +
      '<line x1="8.6" y1="17" x2="15.4" y2="17"/>',
    pluton:
      '<circle cx="12" cy="6.2" r="2.4"/>' +
      '<path d="M6.4 6.4a5.6 5.6 0 0 0 11.2 0"/>' +
      '<line x1="12" y1="12" x2="12" y2="20.6"/>' +
      '<line x1="8.8" y1="16.6" x2="15.2" y2="16.6"/>',

    // ── Signos del zodiaco ──
    aries:
      '<path d="M12 20.6V8.2C12 5 10 3.2 7.6 3.2S3.4 5.2 3.4 7.9"/>' +
      '<path d="M12 8.2C12 5 14 3.2 16.4 3.2s4.2 2 4.2 4.7"/>',
    tauro:
      '<circle cx="12" cy="14.2" r="6.2"/>' +
      '<path d="M4.8 3.2a7.2 7.2 0 0 0 14.4 0"/>',
    geminis:
      '<path d="M4.6 4c4.6 2 10.2 2 14.8 0"/>' +
      '<path d="M4.6 20c4.6-2 10.2-2 14.8 0"/>' +
      '<line x1="8.6" y1="5.2" x2="8.6" y2="18.8"/>' +
      '<line x1="15.4" y1="5.2" x2="15.4" y2="18.8"/>',
    cancer:
      '<circle cx="7" cy="9.2" r="2.6"/>' +
      '<circle cx="17" cy="14.8" r="2.6"/>' +
      '<path d="M4.4 8.4A11.5 11.5 0 0 1 20 5.8"/>' +
      '<path d="M19.6 15.6A11.5 11.5 0 0 1 4 18.2"/>',
    leo:
      '<circle cx="6.4" cy="14.4" r="2.7"/>' +
      '<path d="M9.1 14.4c-.6-5.4 1.5-10 5-10 2.9 0 4.7 2.4 4.7 5.3 0 3.8-2.9 5.9-2.9 8.7 0 1.5 1 2.2 2.6 1.7"/>',
    virgo:
      '<path d="M3.2 19.6V8c0-1.9.9-3.2 2.3-3.2S7.8 6.1 7.8 8v11.6"/>' +
      '<path d="M7.8 8c0-1.9.9-3.2 2.3-3.2S12.4 6.1 12.4 8v11.6"/>' +
      '<path d="M12.4 8c0-1.9.9-3.2 2.3-3.2S17 6.1 17 8v6.6c0 3.2-1.8 5-4.6 6"/>' +
      '<path d="M17 11.4c2.6 1 3.9 3 3.2 5.6"/>',
    libra:
      '<line x1="4" y1="19" x2="20" y2="19"/>' +
      '<path d="M4 14.4h4.2"/>' +
      '<path d="M15.8 14.4H20"/>' +
      '<path d="M8.2 14.4a3.8 3.8 0 1 1 7.6 0"/>',
    escorpio:
      '<path d="M3.2 19.6V8c0-1.9.9-3.2 2.3-3.2S7.8 6.1 7.8 8v11.6"/>' +
      '<path d="M7.8 8c0-1.9.9-3.2 2.3-3.2S12.4 6.1 12.4 8v11.6"/>' +
      '<path d="M12.4 8c0-1.9.9-3.2 2.3-3.2S17 6.1 17 8v8.4c0 2 1.2 3.2 3.2 3.2"/>' +
      '<polyline points="18.4 17.2 20.8 19.6 18.4 21.4"/>',
    sagitario:
      '<line x1="4.2" y1="19.8" x2="19.4" y2="4.6"/>' +
      '<polyline points="12.6 4.6 19.4 4.6 19.4 11.4"/>' +
      '<line x1="7.6" y1="12.4" x2="11.6" y2="16.4"/>',
    capricornio:
      '<path d="M3.2 4.4c1.6 0 2.6 1 3 2.8l2 8.4"/>' +
      '<path d="M8.2 15.6l2.9-9.2c.5-1.4 1.4-2 2.5-2"/>' +
      '<path d="M13.6 4.4c2.2 0 3.4 1.5 3.4 3.4v7.4a3.9 3.9 0 1 1-3.9 3.9"/>',
    acuario:
      '<polyline points="3.2 9.4 6.7 6.2 10.2 9.4 13.7 6.2 17.2 9.4 20.7 6.2"/>' +
      '<polyline points="3.2 17.6 6.7 14.4 10.2 17.6 13.7 14.4 17.2 17.6 20.7 14.4"/>',
    piscis:
      '<path d="M6.2 3.2c3.2 4.4 3.2 13.2 0 17.6"/>' +
      '<path d="M17.8 3.2c-3.2 4.4-3.2 13.2 0 17.6"/>' +
