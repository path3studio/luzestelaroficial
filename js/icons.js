...
(function () {
  ...
  var ICONS = {
    ...
    'sol-astro':
      ...
      '<circle cx="12" cy="12" r="1.5" fill="#d4a849" stroke="none"/>',
    mercurio:
    ...
    pluton:
      '<path d="M7.5 4v16"/>' +
      '<path d="M7.5 4h4.2a3.6 3.6 0 0 1 0 7.2H7.5"/>' +
      '<path d="M7.5 20h8.6"/>',
    ...
    virgo:
      ...
      '<path d="M15 11v9"/>' +
      '<path d="M15 13.5c2.6-.5 4.4 1 4.2 3-.2 1.9-2.1 3-3.8 2.4-1.4-.5-2.4-1.9-3.1-3.4"/>',
    libra:
    ...
    escorpio:
      ...
      '<path d="M10 11a2.5 2.5 0 0 1 5 0"/>' +
      '<path d="M15 11v8.4"/>' +
      '<line x1="15" y1="19.4" x2="20.6" y2="13.8"/>' +
      '<polyline points="17.6 13.8 20.6 13.8 20.6 16.8"/>',
    sagitario:
      '<line x1="4.2" y1="19.8" x2="19.4" y2="4.6"/>' +
      '<polyline points="12.6 4.6 19.4 4.6 19.4 11.4"/>' +
      '<line x1="7.6" y1="12.4" x2="11.6" y2="16.4"/>',
    capricornio:
      '<path d="M4.2 7.8c2-.7 3.5.5 4.1 2.5l1.5 5.2"/>' +
      '<path d="M9.8 15.5c.3-3.5 1.2-6.2 2.9-7.8 2.1-2 5-.9 5.3 2 .2 2.2-1.1 4.1-3 5"/>' +
      '<path d="M15.2 14.7a3.1 3.1 0 1 1-1.5 5.8"/>',
    acuario:
